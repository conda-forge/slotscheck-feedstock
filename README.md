...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/slotscheck-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15066&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/slotscheck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `slotscheck` can be installed with:

```
conda install slotscheck
```

It is possible to list all of the versions of `slotscheck` available on your platform with:
